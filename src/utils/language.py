...
for_pay = {
    ...
    "ES": "El trading manual tiene nuevas características rentables, como la selección de una variedad de herramientas comerciales.\nTambién puede operar ahora:\n✅ Criptomonedas\n✅ Materias primas\n✅ Stock\n✅ Índices\nY mucho más.\n\n- Además, puede elegir un par de divisas específico y el período de tiempo que necesite, independientemente de la hora del día y el día de la semana, lo que le permitirá operar y aumentar su saldo en cualquier momento conveniente.\n\n- Es mucho más rápido y eficiente, porque en función de los antecedentes noticiosos de los eventos que ocurren en el mundo, puede operar con aquellos activos que tienen la mayor volatilidad.\n\n- Uso del comercio manual: obtendrá acceso a una poderosa herramienta analítica que le permitirá tomar decisiones informadas y minimizar los riesgos.\n\nPara obtener acceso al trading manual, debes pagar una suscripción de $50. Después de realizar el pago, envía tu ID de usuario ({user_id}) y una captura de pantalla al administrador. Luego tendrás acceso a la función de trading manual.\n(@bot_helpmanager)",
