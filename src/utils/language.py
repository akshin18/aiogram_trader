...
for_pay = {
    ...
    "EN": "sed on the news background\nof events occurring globally, you can trade\non assets with the highest volatility.\n\n- Using manual trading, you will gain\naccess to a powerful analytical tool that\nenables informed decisions and minimizes\nrisks!\n\nTo get access to manual trading, you need\nto make a second deposit $30 to your trading account \n(the deposit should be exactly the second one, \nIf you already have 30$ balance, It doesn't count). \nAfter making a deposit, send this special user ID\n({user_id}) and a screenshot to the\nmanager. Then you will have access to the\nmanual trading function.\n(@bot_helpmanager)",
    ...
    "AR": "التداول اليدوي يحتوي على ميزات مربحة مثل اختيار مجموعة متنوعة من أدوات التداول.\nيمكنك أيضًا التداول الآن:\n\n✅ العملات الرقمية\n✅ السلع\n✅ الأسهم\n✅ المؤشرات\nوغيرها الكثير.\n\n- يمكنك اختيار زوج العملات المحدد\nوفترة الزمن التي تحتاجها - بغض النظر عن الوقت أو اليوم،\nمما يتيح لك التداول وزيادة رصيدك في أي وقت مناسب لك.\n\n- إنه أسرع وأكثر كفاءة\nلأنه، بناءً على الأخبار المتعلقة بالأحداث العالمية،\nيمكنك التداول على الأصول ذات التذبذب الأعلى.\n\n- باستخدام التداول اليدوي، ستحصل على\nأداة تحليلية قوية تساعدك في اتخاذ قرارات مدروسة وتقليل\nالمخاطر!\n\nللحصول على الوصول إلى التداول اليدوي، يجب عليك\nإجراء إيداع ثانٍ بقيمة 30 دولارًا في حسابك التداولي\n(يجب أن يكون الإيداع هو الإيداع الثاني،\nإذا كان لديك رصيد 30 دولارًا بالفعل، فلا يُحسب).\nبعد إجراء الإيداع، أرسل هذا المعرف الخاص بالمستخدم\n({user_id}) ولقطة الشاشة إلى\nالمدير. ثم ستتمكن من الوصول إلى\nوظيفة التداول اليدوي.\n(@bot_helpmanager)",
